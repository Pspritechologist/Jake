...
pub struct CliArgs {
	#[clap(subcommand)]
	pub command: JakeCommand,
	#[clap(flatten)]
	pub path_args: JakePathArgs,
}

#[derive(Debug, Clone, clap::Subcommand)]
pub enum JakeCommand {
	/// Generates shell completions for the CLI.
	/// 
	/// Either run `source <(jake completions SHELL)` or add the same line to your shell's configuration file.
	Completion { shell: clap_complete::Shell },
	
	/// Build a Jake site.
	/// 
	/// This command processes a Jake project and writes the output to the target directory.
	Build,
	...
	/// Cleans temporary data of a Jake project.
	/// 
	/// This command removes all 'temporary' data generated by Jake.
	/// This includes the output directory.
	Clean,
}

#[derive(Debug, Clone, clap::Args)]
pub struct JakePathArgs {
	#[arg(short, long, env="JAKE_DIR")]
	/// The path of the project directory to process.
	/// If omitted, the current directory will be used.
	pub dir: Option<std::path::PathBuf>,

	#[arg(short, long, env="JAKE_OUT_DIR")]
